            ...
            <div className="features">
                <div className="container">
                    <div className="item">
                        ...
                        <p>
                            Our team is always here to answer your questions and provide support 24 hour per day 7 days
                            per
                            week
                        </p>
                    </div>
            ...
            <div className="features dark">
                <div className="container">
                    <div className="item">
                        ...
                        <button onClick={()=> alert('Coming soon')}>Explore Drill Business</button>
                    </div>
                    <div className="item">
